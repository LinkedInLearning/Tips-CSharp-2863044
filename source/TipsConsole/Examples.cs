...
namespace TipsConsole
{
	...
	{ 
		public void ShowExample()
		{
			...
			// think of discards as a temporary, dummy variables that are intentionally unused in application code. 
			// Discards are equivalent to unassigned variables; they do not have a value.
		...
		{
			var robot = new Robot { Name = "X632", HasWheels = true, SensorCount = 12 };
